...
<div class="top">
    <a href="index.php?action=formAddGenre" class ="button-center">
...
?>
    <div class="genre-role-box bg">
        ...
        <div class="genre-role-actions">
            <a href="index.php?action=formEditGenre&id=<?= $genre["id_genre_film"] ?>">
            ...
            {
            ?>
                <a href="index.php?action=deleteGenre&id=<?= $genre["id_genre_film"] ?>">
                    <button type="bouton" class="button button-round">
