...
<div class="top">
    <button type="bouton" class="button button-large button-center"><a href="index.php?action=formAddActeur">Ajouter un acteur</a></button>
</div>
    ...
    <div class="personne-box bg">
        ...
        <div class="personne-main">
            ...
            <button type="bouton" class="button button-round">
                <a href="index.php?action=formEditActeur&id=<?= $acteur["id_acteur"] ?>">
