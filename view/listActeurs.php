...
<div class="top">
    <button type="bouton" class="button button-large button-center"><a href="index.php?action=addActeur">Ajouter un acteur</a></button>
</div>
...
?>
    <div class="personne-box bg">
        ...
        <div class="personne-main">
            ...
            <button type="bouton" class="button button-large button-center"><a href="index.php?action=listFilms&id=<?= $acteur["id_acteur"] ?>">Voir les films</a></button>
