    ...
    ?>
        <article>
            <div class="content">
                ...
                <div class="actions">
                    <a href="index.php?action=formEditRealisateur&id=<?= $realisateur["id_realisateur"] ?>" title="Modifier le réalisateur">
                    ...
                    ?>
                        <a href="index.php?action=deleteRealisateur&id=<?= $realisateur["id_realisateur"] ?>" title="Supprimer le réalisateur">
