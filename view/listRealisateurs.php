...
?>
    <div class="personne-box bg">
        ...
        <div class="personne-main">
            ...
            <button type="bouton" class="button-very-large button-center"><a href="index.php?action=listFilms&id=<?= $realisateur["id_realisateur"] ?>">Voir la filmographie</a></button>
        </div>
    </div>
<?php }
