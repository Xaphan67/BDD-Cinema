...
<div class="section">
    ...
    <div class="actions">
        ...
        <a href="index.php?action=deleteFilm&id=<?= $infosfilm["id_film"] ?>" title="Supprimer le film">
            ...
            <ul class="list">
                ...
                <li>Genres : <?php
                    foreach ($infosGenres as $key => $genre) {
                        if ($key <= count($infosGenres) - 3) {
                            echo '<a href="index.php?action=infoGenre&id=' . $genre["id_genre_film"] . '">' . $genre["libelle_genre_film"] . "</a>, ";
                        } else if ($key == count($infosGenres) - 2) {
                            echo '<a href="index.php?action=infoGenre&id=' . $genre["id_genre_film"] . '">' . $genre["libelle_genre_film"] . "</a> et ";
                        }
                        else {
                            echo '<a href="index.php?action=infoGenre&id=' . $genre["id_genre_film"] . '">' . $genre["libelle_genre_film"] . "</a>";
                        }
